...
export declare class OrdreMissionController {
    private readonly ordreMissionService;
    constructor(ordreMissionService: OrdreMissionService);
    create(createOrdreMissionDto: CreateOrdreMissionDto): Promise<OrdreMissionResponseDto>;
    findAll(paginationQuery: OrdreMissionPaginationQueryDto): Promise<import("libs/dto/global/response.dto").PaginatedResponseDto<OrdreMissionResponseDto>>;
