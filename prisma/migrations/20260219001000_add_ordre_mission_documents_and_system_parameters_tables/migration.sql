...
-- AddForeignKey
ALTER TABLE "ordres_missions" ADD CONSTRAINT "ordres_missions_chef_bureau_id_fkey" FOREIGN KEY ("chef_bureau_id") REFERENCES "agents"("id") ON DELETE SET NULL ON UPDATE CASCADE;
ALTER TABLE "ordres_missions" ADD CONSTRAINT "ordres_missions_chef_section_id_fkey" FOREIGN KEY ("chef_section_id") REFERENCES "agents"("id") ON DELETE SET NULL ON UPDATE CASCADE;
