...
export const PERMISSIONS = {
  ...
  // Maisons de Transit - Demandes
  MAISON_TRANSIT_REQUESTS_READ: 'maison_transit_requests.read',
  MAISON_TRANSIT_REQUESTS_INVITE: 'maison_transit_requests.invite',
  MAISON_TRANSIT_REQUESTS_REVIEW: 'maison_transit_requests.review',
  MAISON_TRANSIT_REQUESTS_DELETE: 'maison_transit_requests.delete',
